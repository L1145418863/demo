...
public class MyMusicPlayerView extends RelativeLayout {
    ...
    public ImageView my_music_get_height;
    ...
    public ImageView my_music_showpopup;
    public LinearLayout my_music_get_toastheight;
    ...
    public MyMusicPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        findView(context);
        context.bindService(new Intent(context, MusicPlayerService.class), conn, BIND_AUTO_CREATE);
        Log.e("MusicPlayerService","0");
    ...
    ServiceConnection conn = new ServiceConnection() {
        public void onServiceConnected(ComponentName name, IBinder service) {
            Log.v("MusicPlayerService", "onServiceConnected");
        }

        public void onServiceDisconnected(ComponentName name) {
            Log.v("MusicPlayerService", "onServiceDisconnected");
        }
    };
    ...
    private void initView(View view) {
        ...
        my_music_get_height = (ImageView) view.findViewById(R.id.my_music_get_height);
        ...
        my_music_showpopup = (ImageView) view.findViewById(R.id.my_music_showpopup);
        my_music_get_toastheight = (LinearLayout) view.findViewById(R.id.my_music_get_toastheight);
    ...
    public void setUp(String path, String imageUrl) {
        ...
        try {
            if (TextUtils.isEmpty(path)) {
                ...
                headers.put("Referer", "http://*.onlyboss.com/");
                mediaPlayer.setDataSource(context, parse, headers);
    ...
    private void changedSpeed(float speed) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (!TextUtils.isEmpty(path)) {
                ...
                new CenterToast(this.getContext(), speedString, my_music_get_height, my_music_get_toastheight);
